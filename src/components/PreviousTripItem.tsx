...
interface PreviousTripItemProps {
...
const PreviousTripItem: React.FC<PreviousTripItemProps> = ({ arePreviousTrips, tripId, type, date, start, end, carModel, licPlate, destiny, passengers }) => {
...
export default PreviousTripItem